#ifndef _samplePDFDUNENDBase_h_
#define _samplePDFDUNENDBase_h_
...
class samplePDFDUNENDBase : virtual public samplePDFFDBase
{
public:
  samplePDFDUNENDBase(double pot, std::string mc_version, covarianceXsec* xsec_cov);
  ~samplePDFDUNENDBase();
