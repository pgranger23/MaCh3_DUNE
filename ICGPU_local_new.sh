...
DATE=$(date "+%x")
DATE=${DATE//\/}
MACH3_DIRECTORY="/vols/t2k/users/ljw20/software/MaCh3_DUNECPM"
#what is the name of the executable?
exe="jointFitDUNE_noconfig"
...
original_config="mach3dune_config.cfg"
...
OUTDIRNAME=MaCh3_${TYPE}_${RC}_${INITIALDATE}
...
do
  ...
  new_config="MaCh3_DUNE_${TYPE}_${RC}_${RESOURCE}_${MACHINE}_${DATE}_chain${chain}_job${JOB}.cfg"
  ...
  echo "sed -i \"s|^OUTPUTNAME.*|OUTPUTNAME = \"\\\"/vols/t2k/users/ljw20/fit_results/${FOLDER}/${OUTDIRNAME}/MaCh3_DUNEfit_${TYPE}_${RC}_${DATE}_${RESOURCE}_${MACHINE}_chain${chain}_job${JOB}.root\\\"\"|g\" configs/$new_config" >> $script
  ...
  echo "$exe configs/$new_config &> /vols/t2k/users/ljw20/fit_results/${FOLDER}/${OUTDIRNAME}/MaCh3_DUNEfit_${TYPE}_${RC}_${DATE}_${RESOURCE}_${MACHINE}_chain${chain}_job${JOB}.txt &" >> $script

  #now submit the chain!
  sub=". $script &> /dev/null &"
  echo "submiited job locally to $RESOURCE"
  echo "piping output to /vols/t2k/users/ljw20/${FOLDER}/${OUTDIRNAME}/MaCh3_DUNEfit_${TYPE}_${RC}_${DATE}_${RESOURCE}_${MACHINE}_chain${chain}_job${JOB}.txt"
  eval $sub
